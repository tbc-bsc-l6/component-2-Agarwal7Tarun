                        ...
                        <form action="" method="post" id="editCategory" name="editCategory">
                            ...
                            <div class="card-body  p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="<?php echo e($category->name); ?>" name="name" id="name" placeholder="Enter Name" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-4">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\component-2-Agarwal7Tarun\JobPortal\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>