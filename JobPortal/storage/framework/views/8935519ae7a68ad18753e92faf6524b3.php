            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action="" method="post" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input type="text" value="<?php echo e(Request::get('keyword')); ?>" name="keyword" id="keyword" placeholder="Keywords" class="form-control">
                        </div>

                        <div class="mb-4">
                            <h2>Location</h2>
                            <input type="text" value="<?php echo e(Request::get('location')); ?>" name="location" id="location" placeholder="Location" class="form-control">
                        </div>
                            ...
                            <?php if($jobTypes->isNotEmpty()): ?>
                                <?php $__currentLoopData = $jobTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check mb-2">
                                        <input <?php echo e((in_array($jobType->id,$jobTypeArray) ? 'checked' : '')); ?> class="form-check-input " name="job_type" id="job-type-<?php echo e($jobType->id); ?>" type="checkbox" value="<?php echo e($jobType->id); ?>" >
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p><?php echo e(Str::words( strip_tags($job->description), $words=6, '...')); ?></p>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\component-2-Agarwal7Tarun\JobPortal\resources\views/front/jobs.blade.php ENDPATH**/ ?>